...
{
    public class NfePossuiItensValidatorTests
    {

        [Fact]
        public void DeveRetornarNullQuandoNfePossuirItens()
        {
            // Arrange
        ...
        [Fact]
        public void DeveRetornarNaoPossuiItensQuandoNfeNaoPossuirItens()
        {
            // Arrange
            var chave = new ChaveAcessoNfe("12345678901234567890123456789012345678901234");
            ...
            Assert.Equal("A NF-e não possui itens.", resultado);
        }
    }
}
